...
export const placeOrder = async (req, res) => {
  try {
    ...
    // FIX: Using 'user' field name to match your Cart Schema requirement
...
export const updateOrderStatus = async (req, res) => {
  try {
    // FIX: Accept 'status' (standard) or 'orderStatus' (common frontend typo)
    ...
    // Allow Cancellation even if Delivered status is accidentally hit, 
    // but generally, we prevent modification of completed orders.
